module.exports = {
	id: "31",
	caseletId: "31",
	name: "emrNewAddPatientMovementonOnClickADTIcon",
	...
	data: [
		...
		{
			caseletStepId: "10",
			data: "CCU - Coronary Intensive Care Unit"
		},
		{
			caseletStepId: "11",
...
//testcase mapping, handler mapping, controller
	...
	verify: function() {
     ...
     console.log('2nd verify')
		...
		element.all(by.repeater('order in getPatientMovementOrderList')).count().then(function(count) {
