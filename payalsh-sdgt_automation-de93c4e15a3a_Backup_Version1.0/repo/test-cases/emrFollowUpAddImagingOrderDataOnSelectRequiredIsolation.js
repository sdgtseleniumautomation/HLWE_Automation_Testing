module.exports = {
	id: "246",
	caseletId: "246",
	name: "emrFollowUpAddImagingOrderDataOnSelectRequiredIsolation",
...
//testcase mapping, handler mapping, controller
	...
	verify: function() {
     ...
     console.log('2nd verify')
		...
		element.all(by.repeater('order in getImagingOrderList')).count().then(function(count) {
