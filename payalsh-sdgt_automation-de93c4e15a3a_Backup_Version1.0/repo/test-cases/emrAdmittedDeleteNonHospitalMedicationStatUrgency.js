module.exports = {
	id: "487",
	caseletId: "487",
	name: "emrAdmittedDeleteNonHospitalMedicationStatUrgency",
	...
	data: [
		...
		{
			caseletStepId: "11",
			data: "ABILIFY 15MG TABLETS(undefined)"
		},
		{
			caseletStepId: "12",
			data: "200"
...
//testcase mapping, handler mapping, controller
	...
	verify: function() {
     ...
     console.log('2nd verify')
		...
		element.all(by.repeater('order in nonHospitalMedicationOrderList')).count().then(function(count) {
