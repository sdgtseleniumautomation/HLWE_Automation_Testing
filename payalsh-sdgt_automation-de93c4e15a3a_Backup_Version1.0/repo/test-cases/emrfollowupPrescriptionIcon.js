module.exports = {
	id: "314",
	caseletId: "314",
	name: "emrfollowupPrescriptionIcon",
...
//testcase mapping, handler mapping, controller
	...
	verify: function(done) {
     ...
     var control=element(by.xpath('//*[@id="prescriptionNote_mainModal"]/div/div/div[1]/div'));
      control.getText().then(function(text){
       if(text=='Prescription Note/Discharge Summary')
       {
