module.exports = {
	id: "280",
	caseletId: "280",
	name: "emrFollowupOrdrlistSurgicalOptionRegularUrgency",
	...
	data: [
		...
		{
			caseletStepId: "12",
			data: "Therapeutic ultrasound of vessels of head and neck"
		},
		{
			caseletStepId: "13",
			data: "Procedures and interventions, Not Elsewhere Classified"
		},
		{
			caseletStepId: "14",
			data: "DR AZIZI AHMAD"
...
//testcase mapping, handler mapping, controller
	...
	verify: function() {
     ...
     console.log('2nd verify')
		...
		element.all(by.repeater('order in getProcedureSurgicalOrderList')).count().then(function(count) {
