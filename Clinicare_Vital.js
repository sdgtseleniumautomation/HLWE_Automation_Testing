...
element(by.id('opDrug')).sendKeys('Anexate Injection 0.5mg/5ml').element(by.xpath('/html/body/div[3]/div[1]/div[2]/div[1]/div/div/div[2]/div/div/div[2]/div[1]/div/div/div/div/div[2]/div[2]/div/div[1]/form/div/div[2]/div[1]/div/div/ul/li/a/strong')).click();


//Mention the Frequency of the Medicine
element(by.id('inputScheduleFrequency')).sendKeys('Twice A Week').element(by.xpath('/html/body/div[3]/div[1]/div[2]/div[1]/div/div/div[2]/div/div/div[2]/div[1]/div/div/div/div/div[2]/div[2]/div/div[1]/form/div/div[3]/div[1]/div[1]/ul/li/a/strong')).click();


//Mention the Dosage
element(by.id('opDosage')).sendKeys('4');

//Mention the Quantity
element(by.id('inputQty')).sendKeys('5');
